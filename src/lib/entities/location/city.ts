...
export class City extends Entity {
	...
	// === MODE FLAG (Phase 1.7: Settlement/City Merge) ===
	/**
	 * Determines whether this city was generated by simulation or created manually for RPG purposes
	 * - false: RPG mode (manually created, simple properties)
	...
	/**
	 * Size category for RPG cities (migrated from Settlement entity)
	 * Examples: 'small', 'medium', 'large', 'metropolis'
	 */
	size?: string;

	/**
	 * Fame/reputation level for RPG cities (migrated from Settlement entity)
	 * Examples: 'unknown', 'famous', 'legendary', 'notorious'
	 */
	fame?: string;

	/**
	 * Narrative events for RPG cities (migrated from Settlement entity)
	 * These are story beats rather than simulation events
	 */
	rpgEvents?: string[];

	/**
	 * Flavor text description for RPG cities (migrated from Settlement entity)
	 * Used when isSimulationGenerated = false
	 */
	...
	processTurn(currentTurn: number, availableTilesForExpansion: string[] = []): {
		...
		// Note: Yields are calculated in SimulationEngine.processCityYields() before this method is called
